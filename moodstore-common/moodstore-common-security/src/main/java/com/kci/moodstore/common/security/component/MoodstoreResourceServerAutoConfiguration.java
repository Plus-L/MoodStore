...
public class MoodstoreResourceServerAutoConfiguration {
	 ...
	 */
	@Bean
	public MoodstoreBearerTokenExtractor moodstoreBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
		return new MoodstoreBearerTokenExtractor(urlProperties);
	}
	...
	public OpaqueTokenIntrospector opaqueTokenIntrospector(OAuth2AuthorizationService authorizationService) {
		return new MoodstoreCustomOpaqueTokenIntrospector(authorizationService);
	}
	...
	public RequestInterceptor oauthRequestInterceptor(BearerTokenResolver tokenResolver) {
		return new MoodstoreOAuthRequestInterceptor(tokenResolver);
	}
