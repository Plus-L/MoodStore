...
import com.kci.moodstore.common.feign.annotation.FeignRetry;
import feign.Feign;
 ...
 */
@Slf4j
public class MoodstoreSentinelInvocationHandler implements InvocationHandler {
	...
	MoodstoreSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			MoodstoreSentinelInvocationHandler other = (MoodstoreSentinelInvocationHandler) obj;
