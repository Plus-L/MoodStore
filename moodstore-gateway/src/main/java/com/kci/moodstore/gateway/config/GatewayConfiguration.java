...
import com.kci.moodstore.gateway.filter.PasswordDecoderFilter;
import com.kci.moodstore.gateway.filter.MoodstoreRequestGlobalFilter;
import com.kci.moodstore.gateway.filter.SwaggerBasicGatewayFilter;
import com.kci.moodstore.gateway.filter.ValidateCodeGatewayFilter;
import com.kci.moodstore.gateway.handler.GlobalExceptionHandler;
import com.kci.moodstore.gateway.handler.ImageCodeHandler;
...
public class GatewayConfiguration {
	...
	@Bean
	public MoodstoreRequestGlobalFilter moodstoreRequestGlobalFilter() {
		return new MoodstoreRequestGlobalFilter();
	}
