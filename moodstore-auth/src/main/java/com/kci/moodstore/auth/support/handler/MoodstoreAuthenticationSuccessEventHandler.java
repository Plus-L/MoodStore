 ...
 */
@Slf4j
public class MoodstoreAuthenticationSuccessEventHandler implements AuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		if (MapUtil.isNotEmpty(map)) {
			// 发送异步日志事件
			MoodstoreUser userInfo = (MoodstoreUser) map.get(SecurityConstants.DETAILS_USER);
