DROP DATABASE IF EXISTS `moodstore`;

CREATE DATABASE  `moodstore` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
...
INSERT INTO `sys_menu` VALUES ('9999', '系统官网', null, 'https://moodstore4cloud.com/#/', '-1', 'icon-web-icon-', '999', '0', '0', '0', '', '2019-01-17 17:05:19', 'admin', '2022-11-10 21:40:53');
COMMIT;
...
INSERT INTO `sys_oauth_client_details` VALUES ('pig', NULL, 'pig', 'server', 'password,app,refresh_token,authorization_code,client_credentials', 'https://moodstorex.vip', NULL, NULL, NULL, NULL, 'true', NULL, NULL, NULL, NULL);
